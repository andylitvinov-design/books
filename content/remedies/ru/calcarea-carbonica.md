...
canonical_latin_name: Calcarea Carbonica
russian_common_name:
source_substance:
aliases: Calcarea Carbonica
key_image:
main_state:
observed_effect:
archetype:
...
primary_image_alt: Исходное изображение, прикреплённое к Calcarea Carbonica, message205.
---

Он помогает клиентам мягко сделать шаг вперед в период страхов и ограничений.
