...
test('declares public link handling, safe native navigation, and no automatic verification', () => {
  ...
  assert.match(manifest, /android:scheme="psialchemy" android:host="ru" android:pathPrefix="\/homeopathy\/remedies"/)
  assert.match(manifest, /android:scheme="psialchemy" android:host="en" android:pathPrefix="\/homeopathy\/remedies"/)
  assert.doesNotMatch(manifest, /<data android:scheme="psialchemy" \/>/)
