...
- `manuscript/MAYA_TRADITION_UNIFIED.md` is the canonical manuscript: 122 reader articles in seven shared themes. The four reading volumes are a non-overlapping editorial partition of this manuscript; wording is preserved as captured, and editorial work is limited to headings, source labels, grouping, and duplicate notes.
...
- `manuscript/VOLUME_MAP.md` — the four-volume partition, its chapter boundaries, counts, and published output names.
