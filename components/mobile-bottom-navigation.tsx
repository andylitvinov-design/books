...
export function MobileBottomNavigation() {
  ...
  const labels = locale === 'ru'
    ? [['Главная', '/'], ['Препараты', `/${locale}/homeopathy/remedies`], ['Книги', '/books'], ['Сохранённые', `/${locale}/homeopathy/remedies?saved=1`], ['Ещё', `/${locale}/homeopathy#about`]]
    : [['Home', '/'], ['Remedies', `/${locale}/homeopathy/remedies`], ['Books', '/books'], ['Saved', `/${locale}/homeopathy/remedies?saved=1`], ['More', `/${locale}/homeopathy#about`]]
