...
export const books = [
  ...
  {
    ...maya,
    id: 'maya-tradition-description-deities',
    title: 'Традиция Майя: описание и божественные силы',
    description: 'I. Описание традиции. II. Боги и божественные силы.',
    cover: 'photo_100@06-01-2025_09-34-15.jpg',
    summary: 'I. Описание традиции. II. Боги и божественные силы.',
    originalSourceFile: 'source-books/book-3-maya-tradition/manuscript/MAYA_TRADITION_UNIFIED.md',
    status: 'published',
    tags: ['Описание традиции', 'Боги и божественные силы'],
    chapters: [
      chapter('description', 'I. Описание традиции'),
      chapter('deities', 'II. Боги и божественные силы'),
    ],
    sourceSectionStart: 'I. Описание традиции',
    sourceSectionEnd: 'II. Боги и божественные силы',
  },
  {
    ...maya,
    id: 'maya-tradition-calendar-cosmology',
    title: 'Традиция Майя: календарь, время и космология',
    description: 'III. Календарь, время и космология.',
    cover: 'photo_94@06-01-2025_09-34-04.jpg',
    summary: 'III. Календарь, время и космология.',
    originalSourceFile: 'source-books/book-3-maya-tradition/manuscript/MAYA_TRADITION_UNIFIED.md',
    status: 'published',
    tags: ['Календарь', 'время', 'космология'],
    chapters: [
      chapter('calendar', 'III. Календарь, время и космология'),
    ],
    sourceSectionStart: 'III. Календарь, время и космология',
    sourceSectionEnd: 'III. Календарь, время и космология',
  },
  {
    ...maya,
    id: 'maya-aztec-culture-ritual',
    title: 'Майя и ацтеки: культура, мифология и ритуал',
    description: 'IV. Места, предметы и материальная культура. V. Мифология, Шибальба, инициация и ритуал.',
    cover: 'photo_174@11-02-2025_21-03-16.jpg',
    summary: 'IV. Места, предметы и материальная культура. V. Мифология, Шибальба, инициация и ритуал.',
    originalSourceFile: 'source-books/book-3-maya-tradition/manuscript/MAYA_TRADITION_UNIFIED.md',
    status: 'published',
    tags: ['Места', 'предметы', 'материальная культура', 'Мифология', 'Шибальба', 'инициация', 'ритуал'],
    chapters: [
      chapter('culture', 'IV. Места, предметы и материальная культура'),
      chapter('ritual', 'V. Мифология, Шибальба, инициация и ритуал'),
    ],
    sourceSectionStart: 'IV. Места, предметы и материальная культура',
    sourceSectionEnd: 'V. Мифология, Шибальба, инициация и ритуал',
  },
  {
    ...maya,
    id: 'maya-tradition-models-comparisons',
    title: 'Традиция Майя: авторские модели и сравнения традиций',
    description: 'VI. Авторские, архетипические и терапевтические модели. VII. Сравнения мезоамериканских традиций.',
    cover: 'photo_191@14-03-2025_17-44-23.jpg',
    summary: 'VI. Авторские, архетипические и терапевтические модели. VII. Сравнения мезоамериканских традиций.',
    originalSourceFile: 'source-books/book-3-maya-tradition/manuscript/MAYA_TRADITION_UNIFIED.md',
    status: 'published',
    tags: ['Авторские', 'архетипические', 'терапевтические модели', 'Сравнения мезоамериканских традиций'],
    chapters: [
      chapter('models', 'VI. Авторские, архетипические и терапевтические модели'),
      chapter('comparisons', 'VII. Сравнения мезоамериканских традиций'),
    ],
    sourceSectionStart: 'VI. Авторские, архетипические и терапевтические модели',
    sourceSectionEnd: 'VII. Сравнения мезоамериканских традиций',
  },
]
