...
import { recommendationCopy } from '../documents/recommendation.js'
...
function buildDocument(document, locale, origin, payment = false) {
  ...
  if (payment) {
    ...
    if (document.paymentMethod) block(`${ru ? 'Способ оплаты' : 'Payment method'}: ${document.paymentMethod}`, 9.5, 17, 'F1', '0.43 0.46 0.48')
