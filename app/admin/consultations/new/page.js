...
export default async function NewConsultation() {
  ...
  return <main className="prescription-admin-shell"><PrescriptionAdminHeader title="New consultation" description="Client and remedies → two ready documents." /><ConsultationForm action={createConsultationAction} remedies={getPrescriptionRemedyOptions()} requestId={randomUUID()} /></main>
}
