...
const copy = {
  ru: { title: "Гомеопатия — библиотека авторских материалов", description: "Отдельный раздел библиотеки с источниковыми описаниями 94 подтверждённых препаратов Андрея Литвинова.", kicker: "Отдельный раздел библиотеки", heading: "Гомеопатия", lead: "94 подтверждённых препарата из существующих материалов Андрея Литвинова. Тексты сохранены как образовательный архив с указанием источника.", cta: "Открыть указатель препаратов", note: "22 упоминания без полноценной карточки не опубликованы. Повторяющиеся и групповые исходные заголовки не превращены в отдельные карточки." },
  en: { title: "Homeopathy — author-source library", description: "A dedicated library section with source-based descriptions for 94 confirmed remedies by Andrii Litvinov.", kicker: "A dedicated library section", heading: "Homeopathy", lead: "94 confirmed remedies from existing Andrii Litvinov materials. The texts are preserved as an educational archive with their source reference.", cta: "Open remedy directory", note: "The 22 mention-only items are not published. Duplicate and grouped source headings were not turned into individual cards." },
} as const;
